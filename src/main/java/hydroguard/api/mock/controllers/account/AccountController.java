...
public class AccountController {
    ...
    public void init() {
        ...
        accounts.add(new AccountDTO(UUID.fromString("934b03fa-d8f1-4d8b-8b03-fad8f17d8b0e"), "Jane Smith", "j4n3sm1th", "jane.smith@example.com", 10, "https://robohash.org/a476485bc5d85adc20f23cbf5a02a684?set=set4&bgset=&size=400x400", "06-XXXXXXXX", true, LocalDateTime.now().minusDays(20), LocalDateTime.now().minusDays(2)));
        ...
        accounts.add(new AccountDTO(UUID.randomUUID(), "Bob Brown", "bobb", "bob.brown@example.com", 20, "https://robohash.org/610b9cfb18e50d33e7fef6d56905b992?set=set4&bgset=&size=400x400", "06-XXXXXXXX", true, LocalDateTime.now().minusDays(40), LocalDateTime.now().minusDays(4)));
        ...
        accounts.add(new AccountDTO(UUID.randomUUID(), "Eve Foster", "evef", "eve.foster@example.com", 35, "https://robohash.org/5f7aaf88ccba1265747142e405d72b9c?set=set4&bgset=&size=400x400", "06-XXXXXXXX", true, LocalDateTime.now().minusDays(70), LocalDateTime.now().minusDays(7)));
    }
